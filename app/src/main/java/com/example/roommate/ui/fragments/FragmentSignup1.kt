...
class FragmentSignup1 : Fragment(R.layout.fragment_signup1) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.signup1GoBtn.setOnClickListener {
            findNavController().navigate(R.id.action_fragmentSignup1_to_fragmentSignup2)
        }
    }
}