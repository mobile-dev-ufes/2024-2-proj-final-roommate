...
class FragmentInterestedGroups : Fragment(R.layout.fragment_interested_groups) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        adapter.insertGroupList(GroupModel("Grupo1", "Meu teste de grupo3", 3, 6))
        adapter.insertGroupList(GroupModel("Grupo1", "Meu teste de grupo2", 2, 4))
        adapter.insertGroupList(GroupModel("Grupo1", "Meu teste de grupo1", 1, 2))
    }
}